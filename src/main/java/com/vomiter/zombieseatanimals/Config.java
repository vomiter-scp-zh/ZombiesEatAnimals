...
public final class Config {
    ...
    private static final ModConfigSpec.IntValue FOOD_COMBAT_LOCK_TICKS_VALUE;
    private static final ModConfigSpec.DoubleValue FOOD_COMBAT_LOCK_DISTANCE_VALUE;
